...
import shahid.api.SubmitFail as SubmitFail
    ...
    res12 = WS.sendRequest(findTestObject('null'))
	code = res12.getStatusCode()
	if (code == 200) {
    def responsebody = "TV-Landing-Page Opened Successfully"

	String statuscode = res12.getStatusCode().toString()

	String apiname = 'TV-Landing-Page'
  ...
  -H 'cache-control: no-cache'"
    ...
    WS.verifyResponseStatusCode(res12, 200)  }
	
	
	else {

			def responsebody = res12.getResponseBodyContent().toString()
