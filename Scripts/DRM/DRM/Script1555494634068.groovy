...
res7 = WS.sendRequest(findTestObject('DRM/DRM'))
...
if (code != 200) {
	...
	res8 = WS.sendRequest(findTestObject('DRM/DRM'))
	...
	if (code2 != 200) {
		def responsebody = res8.getResponseBodyContent().toString()
			...
			String apiname = 'DRM-Service'
		
			String URL = "curl -X GET \
  'https://api2.shahid.net/proxy/v2/drm?request=%7B%22assetId%22%3A333538%7D' \
  -H 'Accept: application/json' \
  -H 'Accept-Language: en-US,en;q=0.5' \
  -H 'Authorization: AWS4-HMAC-SHA256 Credential=AKIAI6X4TYCIXM2B7MUQ/20190417/us-east-1/execute-api/aws4_request, SignedHeaders=accept;browser_name;browser_version;host;os_version;shahid_os;token;x-amz-date;x-api-key, Signature=1cf074cbed88c654a450fc4e05b1043997dc375207dc2939334acce6189218a8' \
  ...
  -H 'Postman-Token: ecb6de8e-0136-4cdc-8f6b-d382fd79bff7' \
  ...
  -H 'x-api-key: 2RRtuMHx95aNI1Kvtn2rChEuwsCogUd4samGPjLh'"
	...
	res9 = WS.sendRequest(findTestObject('DRM/DRM'))
	def responsebody = "DRM Service Works Fine"
